...
$rcp->comp_code = $comp_code;
$get_compName = $rcp->GetCompName();
while ($row = $get_compName->fetch(PDO::FETCH_ASSOC)) {
    extract($row);
...
// Set some content to print
    ...
    $tbl = '
        <table  cellpadding="4">
        <tr nobr="true">
            <th colspan="7"><strong>'.$comp_name.' COMPANY</strong></th>
            <th rowspan="2" colspan="3" align="right"><strong>REQUEST FOR CHECK PAYMENT</strong></th>
         </tr>
         <tr nobr="true">
            <th colspan="5" style="font-size: 10px">Reports from <strong>'.$mFrom.'</strong> to <strong>'.$mTo.'</strong></th>
         </tr>
         <tr nobr="true" style="font-size: 10px; font-weight: bold;" align="center">
            ...
            <th style=" border-top: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">Requestor</th>
        ...
        $index = 0;
        $mApprvr = array();
        $get_name = $rcp->GetApproverNameCompAdmin();
        while ($row = $get_name->fetch(PDO::FETCH_ASSOC)) {
            extract($row);
            $mApprvr[] =$row['approver_name'];
        }

        $data = $rcp->GetAllCompInRcpAdminFromAndTo();
        ...
        $tbl .= '
            <tr nobr="true" style="font-size: 9px;">
                <td colspan="10" style="border-left: 1px solid black; border-right: 1px solid black;border-bottom: 1px solid black; text-align: center"><strong>NO RECORDS FOUND</strong></td>
            </tr>
        ';
    }
         $tbl .= '
        ...
        <tr nobr="true">
         ...
         <tr nobr="true">
            <th colspan="5" style="font-size: 10px">Reports from <strong>'.$mFrom.'</strong> and above.</th>
         </tr>
         <tr nobr="true" style="font-size: 10px; font-weight: bold;" align="center">
            <th style=" border-top: 1px solid black; border-right: 1px solid black; border-left: 1px solid black; border-bottom: 1px solid black">RCP No.</th>
            <th style=" border-top: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">Requestor</th>
        ...
        $data = $rcp->GetAllCompInRcpAdminFromOnly();
        while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
        extract($row);
        $hasValue = true;
        $tbl .= '
    ...
    $tbl = '
        ...
        <tr nobr="true">
         ...
         <tr nobr="true">
            <th colspan="5" style="font-size: 10px">Reports of <strong>'.$comp_name.'</strong></th>
         </tr>
         <tr nobr="true" style="font-size: 10px; font-weight: bold;" align="center">
            <th style=" border-top: 1px solid black; border-right: 1px solid black; border-left: 1px solid black; border-bottom: 1px solid black">RCP No.</th>
            <th style=" border-top: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">Requestor</th>

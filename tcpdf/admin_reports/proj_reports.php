...
$rcp->proj_code = $proj_code;
$get_projName = $rcp->GetProjName();
while ($row = $get_projName->fetch(PDO::FETCH_ASSOC)) {
    extract($row);
...
// Set some content to print
    ...
    $tbl = '
        <table  cellpadding="4">
        <tr nobr="true">
            <th colspan="7"><strong>'.$proj_name.' PROJECT</strong></th>
        ...
        $index = 0;
        $mApprvr = array();
        $get_name = $rcp->GetApproverNameProjAdmin();
        while ($row = $get_name->fetch(PDO::FETCH_ASSOC)) {
            extract($row);
            $mApprvr[] =$row['approver_name'];
        }

        $data = $rcp->GetAllProjInRcpAdminFromAndTo();
        ...
        $data = $rcp->GetAllProjInRcpAdminFromOnly();
        while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
        extract($row);
        $hasValue = true;
        $tbl .= '
        ...
        <tr nobr="true">
            ...
            <th rowspan="2" colspan="3" align="right"><strong>REQUEST FOR CHECK PAYMENT</strong></th>
             ...
             <tr nobr="true">
                <th colspan="5" style="font-size: 10px">Reports of <strong>'.$proj_name.'</strong></th>
             </tr>
         <tr nobr="true" style="font-size: 10px; font-weight: bold;" align="center">
            <th style=" border-top: 1px solid black; border-right: 1px solid black; border-left: 1px solid black; border-bottom: 1px solid black">RCP No.</th>
            <th style=" border-top: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">Requestor</th>

...
// Set some content to print
        ...
        $tbl = '
            <table  cellpadding="4">
            <tr nobr="true">
                <th colspan="6"><strong>'.$comp_name.' - COMPANY</strong></th>
             ...
             ';
            $rcp->rcp_approver_id = $user_id;
            $rcp->rcp_company = $comp_code;
            $rcp->startDate = $mFrom;
            $rcp->endDate = $mTo;
            $hasValue = false;

            $data = $rcp->GetAllCompInRcpFromAndTo();
        ...
        $tbl = '
            ...
            $data = $rcp->GetAllCompInRcpFromOnly();
            while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
            extract($row);
            $hasValue = true;
            $tbl .= '
        ...
        $tbl = '
            ...
            <tr nobr="true">
             ...
             <tr nobr="true">
                <th colspan="6" style="font-size: 10px">Reports of <strong>'.$comp_name.'</strong></th>
             </tr>
             <tr nobr="true" style="font-size: 10px; font-weight: bold;" align="center">
                <th style=" border-top: 1px solid black; border-right: 1px solid black; border-left: 1px solid black; border-bottom: 1px solid black">RCP No.</th>
                <th style=" border-top: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">Requestor</th>

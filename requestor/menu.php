<div id="sidebar-nav" class="sidebar">
	<div class="sidebar-scroll">
		<nav>
			<ul class="nav">
				<li><a href="../requestor/dashboard-rcp.php" class=""><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
				<li>
					...
					<div id="subPages" class="collapse ">
						<ul class="nav">
							<li><a href="../requestor/approved-rcp.php" class="">Approved</a></li>
							<li><a href="../requestor/declined-rcp.php" class="">Declined</a></li>
						</ul>
					</div>
				</li>
